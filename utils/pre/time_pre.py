...
def get_mol(data):
    ...
    return Molecule(pos, atoms, edges, smi, prop, distance=dists, loc=False, glob=False)
...
if __name__ == '__main__':
    ...
    for data in datas:
        pos, atoms, edges, smi, prop, dists = data
        mols.append(Molecule(pos,atoms,edges,smi,prop,distance=dists,loc=False,glob=False))
        props.append(prop)
        print(i)
        i += 1
