...
class MC_Interaction(nn.Module):
    ...
    def forward(self, g):
        ...
        g.ndata["new_node"] = self.mc_drop1(
            self.bn1(self.node_layer1(g.ndata["node"])))
...
class MC_SchNetModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_layers = nn.ModuleList([
            MC_Interaction(self.rbf_layer._fan_out, dim, self.dropout)
