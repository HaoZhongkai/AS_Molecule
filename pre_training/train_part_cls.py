...
if __name__ == "__main__":
    ...
    # load dataset
    mols_fingerprint = pickle.load(open(train_fingerprint_path,'rb'))

    # mols_fingerprint = mols_fingerprint.to(args.device)

    data_ids = k_medoid(mols_fingerprint,train_data_num,clustering_iters,show_stats=True)
    mols_fingerprint.cpu()
